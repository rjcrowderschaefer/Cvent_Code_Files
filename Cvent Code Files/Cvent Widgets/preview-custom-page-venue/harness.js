...
const STORE_KEY = "page-venue-preview-config";
...
async function main() {
  ...
  if (!customElements.get("preview-page-venue-editor")) customElements.define("preview-page-venue-editor", Editor);
  ...
  const applyPreset = (key) => {
    ...
    api.update(currentConfig);
    try { localStorage.setItem("page-venue-preview-bp", key); } catch {}
  };
  let bp = "desktop";
  try { bp = localStorage.getItem("page-venue-preview-bp") || "desktop"; } catch {}
  $("width").value = bp;
  applyPreset(bp);
